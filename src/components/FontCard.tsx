...
export default function FontCard({ generatedText, size, onCopy }: FontCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center min-h-[72px] py-2 relative z-10 transition-transform duration-500 group-hover:scale-[1.02]">
        <p
          className="text-center break-words leading-tight font-semibold text-slate-800 dark:text-slate-100"
